...
public class CircleMenuLayout extends ViewGroup {
    ...
    public CircleMenuLayout(Context context, AttributeSet attrs) {
        ...
        mNoclickValue = (int) (viewCig.getScaledTouchSlop() / 2f + 0.5f);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        float x = event.getX();
        float y = event.getY();
        float z = event.getRawX();
        float w = event.getRawY();
        RectF rect = calcViewScreenLocation(getChildAt(0));
        boolean isInViewRect = rect.contains(z, w);
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                //判断是否在中心圆范围内
                // 重新布局
                if (Math.abs(mTmpAngle) > mNoclickValue && !isInViewRect) {
                    requestLayout();
                    mLastX = x;
                    mLastY = y;
                }
            ...
            case MotionEvent.ACTION_UP:
                ...
                // 如果当前旋转角度超过mNoclickValue屏蔽点击
                if (Math.abs(mTmpAngle) > mNoclickValue) {
                    return true;
                }
                break;
        }
     ...
     * @param resIds
     */
    public void setMenuItemIconsAndTexts(int[] resIds, int[] texts) {
        mItemImgs = resIds;
        mItemTexts = texts;
    ...
    public boolean getIsFling() {
        return isFling || Math.abs(mTmpAngle) > mNoclickValue;
    }
    ...
    private void addMenuItems() {
        ...
        for (int i = 0; i < mMenuItemCount; i++) {
            ...
            ImageView iv1 = (ImageView) view.findViewById(R.id.id_circle_menu_item_delete);
            ...
            if (iv1 != null) {
                iv1.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (mOnMenuItemClickListener != null) {
                            mOnMenuItemClickListener.itemDeleteClick(v, j);
            ...
            if (tv != null) {
                ...
                if (mItemTexts[i] != 0) {
                    tv.setText(getContext().getString(mItemTexts[i]));
                }
                view.setTag(mItemTexts[i]);
            }
    ...
    public void refreshCenterItem(int resId) {
     ...
     * @param pos     位置
     * @param resId   图片资源id
     * @param titleId 菜单名称id
     */
    public void refreshMenuItem(int pos, int resId, int titleId) {
    ...
    public interface OnMenuItemClickListener {
        ...
        void itemDeleteClick(View v, int j);
    }
