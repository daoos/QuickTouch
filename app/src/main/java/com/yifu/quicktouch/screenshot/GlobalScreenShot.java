...
public class GlobalScreenShot {
    ...
    public void takeScreenshot(Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                mScreenBitmap = ScreenShotFunction.screenshot(mContext);
    ...
    private void notifyScreenshotError(Context context) {
        Toast.makeText(context, "没有系统权限", Toast.LENGTH_SHORT).show();
    }
    ...
    class UiHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            startAnimation(mFinisher, mDisplayMetrics.widthPixels, mDisplayMetrics.heightPixels,
                    mStatusBarVisible, mNavBarVisible);
        }
    }
