...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "FloatWindow";
    ...
    public static void putIntArray(Context context, String key, int[] intArray) {
    ...
    public static void putStringArray(Context context, String key, String[] intArray) {
        SharedPreferences prefs = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
        JSONArray jsonArray = new JSONArray();
        for (String b : intArray) {
            jsonArray.put(b);
        }
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(key, jsonArray.toString());
